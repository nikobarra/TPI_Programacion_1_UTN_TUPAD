...
def cargar_csv(nombre_archivo):
    ...
    if not os.path.exists(nombre_archivo):
        imprimir_cuadro_advertencia(f"El archivo {nombre_archivo} no existe. Iniciando lista vacía.")
        return lista_paises
    ...
    try:
        ...
        if lista_paises:
            imprimir_cuadro_exito(f"Se cargaron {len(lista_paises)} países correctamente.")
        else:
            imprimir_cuadro_advertencia("El archivo CSV estaba vacío o no tenía datos válidos.")
